 ...
 import { ArrowLeft, Check, Clock, Scissors, Sparkles, CreditCard, Smartphone, Banknote, Calendar } from "lucide-react";
 ...
 const Booking = () => {
   ...
   const canProceed = () => {
     switch (step) {
       ...
       case 4: return selectedPayment !== null;
       default: return true;
     }
   };
     ...
     <div className="min-h-screen bg-background">
       ...
       <main className="max-w-3xl mx-auto px-6 py-8">
         <AnimatePresence mode="wait">
           ...
           {/* Step 5: Confirmation */}
           {step === 5 && (
             <motion.div key="step5" variants={stepVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3 }} className="text-center">
               <motion.div
                 initial={{ scale: 0 }}
                 animate={{ scale: 1 }}
       ...
       {step < 5 && (
         <footer className="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-sm border-t border-border p-4">
           <div className="max-w-3xl mx-auto">
             ...
             >
               {step === 3 ? "Zur Zahlung" : step === 4 ? "Termin bestätigen" : "Weiter"}
             </Button>
           </div>
         </footer>
       )}
